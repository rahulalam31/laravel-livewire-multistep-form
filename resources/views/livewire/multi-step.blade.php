        ...
        @if ($currentStep == 1)
            <div id="step-1" class="clientFrom step p-0" data-id='1'>
                ...
                <div class="modal-px-60 pt-5">
                    <input type="email" name="email" placeholder="Enter Email Address" class="input-style input-font-bold"
                        wire:modal="email" required />
                        <span class="text-danger">@error('email'){{ $message }}@enderror</span>

                    <div class="d-flex mt-4">
                        <div class="ui fluid search selection dropdown input-font-bold" id="country">
                            <input type="hidden" name="country" wire:modal="country" required/>
                        ...
                        <input type="tel" placeholder="Enter Phone Number"
                            class="input-style input-font-bold ps-3" name="phone" wire:modal="phone" required/>
                ...
                <div class="modal-content radius24">
                    <div class="pt-5">
                        ...
                        <div class="modal-body pt-4 modal-px-60">
                            ...
                            <div class="mb-5">
                                <tinymce-editor wire:model="editor" name="editor">{{ $editor }}</tinymce-editor>
                                <span class="text-danger">@error('editor'){{ $message }}@enderror</span>

                                {{-- <textarea class="summernote" id="summernote" wire:model="editor">{{ $editor }} </textarea> --}}
                            </div>
                        </div>
                                            ...
                                            <div class="fileUploadWrap">
                                                <div>
                                                    <img src="images/register-assets/upload-files.png" alt=""
                                                        class="DropIcon" />
                                                    <input type="file" name="photo" wire:modal="photo" required>
