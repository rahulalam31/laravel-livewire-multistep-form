    ...
    <form  wire:submit.prevent="register" id="myForm">
        ...
        <div id="step-1" class="clientFrom step p-0" data-id='1'>
            ...
            <div class="modal-px-60 pt-5">
                <input type="email" placeholder="Enter Email Address" class="input-style input-font-bold" wire:modal="email" />

                <div class="d-flex mt-4">
                    <div class="ui fluid search selection dropdown input-font-bold" id="country">
                        <input type="hidden" name="country" wire:modal="country" />
                    ...
                    <input type="tel" placeholder="Enter Phone Number" class="input-style input-font-bold ps-3" wire:modal="phone" />
                </div>

                <div class="text-center">
                    <button class="btn-purple-fill btn-width-sm mt-5 nextScreen next" wire:click="increaseStep()">
                        Get Started
                    </button>
                    <div class="or"></div>
            ...
            <div class="modal-content radius24">
                <div class="pt-5">
                    ...
                    <div class="modal-body pt-4 modal-px-60">
                        ...
                        <div class="mb-5">
                            <textarea id="editor" wire:modal="editor"> </textarea>
                        </div>
                    </div>

                    <div class="text-center mt-5 pt-5 mb-5">
                        <button type="button" class="btn btn-white-fill prevScreen prev" wire:click="decreaseStep()">
                            < Back</button>
                                        ...
                                        <div class="fileUploadWrap">
                                            <div>
                                                <img src="images/register-assets/upload-files.png" alt=""
                                                    class="DropIcon" />
                                                <input type="file" name="import_file" wire:modal="file">
                                            </div>
                                            <div class="parawrap">
